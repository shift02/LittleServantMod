 ...
 *
 */
public class EntityAIAttackRangedBow2<T extends EntityLiving> extends EntityAIBase {

    private final T entity;
    private final IRangedAttackLSM rangedAttack;
    ...
    public EntityAIAttackRangedBow2(T entity, IRangedAttackLSM rangedAttack, ResourceLocation type, double moveSpeedAmp, int attackCooldown, float p_i47515_5_) {
        this.entity = entity;
        ...
        if (entitylivingbase != null) {
            ...
            if (this.entity.isHandActive()) {
                if (!flag && this.seeTime < -60) {
                    ...
                    //どれくらい長押ししたか(最大値はそれぞれのアイテムのgetMaxItemUseDurationが設定される)
                    int i = this.entity.getItemInUseMaxCount();

                    if (i >= rangedAttack.canUseCount()) {
                        this.entity.resetActiveHand();
