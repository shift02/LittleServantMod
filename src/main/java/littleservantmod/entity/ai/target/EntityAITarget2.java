...
/**
 * 特定のEntityをターゲットにするAI
 * @author shift02
 *
 */
public abstract class EntityAITarget2 extends EntityAIBase {

	/** The entity that this task belongs to */
	protected final EntityLittleServantBase taskOwner;
	...
	public EntityAITarget2(EntityLittleServantBase servant, boolean checkSight) {
		this(servant, checkSight, false);
	}

	public EntityAITarget2(EntityLittleServantBase servant, boolean checkSight, boolean onlyNearby) {
		this.unseenMemoryTicks = 60;
		this.taskOwner = servant;
	...
	public EntityAITarget2 setUnseenMemoryTicks(int p_190882_1_) {
