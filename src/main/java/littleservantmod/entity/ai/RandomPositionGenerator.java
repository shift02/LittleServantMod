...
public class RandomPositionGenerator {
     ...
     */
    @Nullable
    public static Vec3d findRandomTarget(EntityLittleServantBase EntityLittleServantBaseIn, int xz, int y)
    {
        return findRandomTargetBlock(EntityLittleServantBaseIn, xz, y, (Vec3d)null);
    }

    @Nullable
    public static Vec3d getLandPos(EntityLittleServantBase p_191377_0_, int p_191377_1_, int p_191377_2_)
    {
     ...
     */
    @Nullable
    public static Vec3d findRandomTargetBlockTowards(EntityLittleServantBase EntityLittleServantBaseIn, int xz, int y, Vec3d targetVec3)
    {
        staticVector = targetVec3.subtract(EntityLittleServantBaseIn.posX, EntityLittleServantBaseIn.posY, EntityLittleServantBaseIn.posZ);
        return findRandomTargetBlock(EntityLittleServantBaseIn, xz, y, staticVector);
    }
     ...
     */
    @Nullable
    public static Vec3d findRandomTargetBlockAwayFrom(EntityLittleServantBase EntityLittleServantBaseIn, int xz, int y, Vec3d targetVec3)
    {
        staticVector = (new Vec3d(EntityLittleServantBaseIn.posX, EntityLittleServantBaseIn.posY, EntityLittleServantBaseIn.posZ)).subtract(targetVec3);
        return findRandomTargetBlock(EntityLittleServantBaseIn, xz, y, staticVector);
    }
     ...
     */
    @Nullable
    private static Vec3d findRandomTargetBlock(EntityLittleServantBase EntityLittleServantBaseIn, int xz, int y, @Nullable Vec3d targetVec3)
    {
        return generateRandomPos(EntityLittleServantBaseIn, xz, y, targetVec3, true);
    }

    @Nullable
    private static Vec3d generateRandomPos(EntityLittleServantBase p_191379_0_, int p_191379_1_, int p_191379_2_, @Nullable Vec3d p_191379_3_, boolean p_191379_4_)
    {
    ...
    private static BlockPos moveAboveSolid(BlockPos p_191378_0_, EntityLittleServantBase p_191378_1_)
    {
    ...
    private static boolean isWaterDestination(BlockPos p_191380_0_, EntityLittleServantBase p_191380_1_)
    {
