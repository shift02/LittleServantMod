...
public class ModelLittleServantBase  extends ModelBiped{
    ...
    public ModelLittleServantBase(float modelSize, boolean smallArmsIn)
    {
        ...
        this.bipedRightLeg.addBox(-2F, -12F, -2F, 3, 9, 4, modelSize);
		this.bipedRightLeg.setRotationPoint(-1F, 0F, 0F);

		this.bipedLeftLeg = new ModelRenderer(this, 32, 19);
		this.bipedLeftLeg.mirror = true;
		this.bipedLeftLeg.addBox(-1F, -12F, -2F, 3, 9, 4, modelSize);
